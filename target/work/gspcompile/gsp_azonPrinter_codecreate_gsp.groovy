...
class gsp_azonPrinter_codecreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(codeInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(codeInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:codeInstance, action:'save'])],2)
printHtmlPart(22)
})
