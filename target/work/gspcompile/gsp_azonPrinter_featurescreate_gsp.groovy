...
class gsp_azonPrinter_featurescreate_gsp extends GroovyPage {
...
invokeTag('eachError','g',25,['bean':(featuresInstance),'var':("error")],3)
printHtmlPart(18)
})
invokeTag('hasErrors','g',27,['bean':(featuresInstance)],2)
printHtmlPart(11)
createTagBody(2, {->
printHtmlPart(19)
...
invokeTag('form','g',35,['url':([resource:featuresInstance, action:'save'])],2)
printHtmlPart(22)
})
...
public static final long LAST_MODIFIED = 1408801314060L
