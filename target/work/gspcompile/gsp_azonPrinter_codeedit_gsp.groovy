...
class gsp_azonPrinter_codeedit_gsp extends GroovyPage {
...
invokeTag('eachError','g',27,['bean':(codeInstance),'var':("error")],3)
printHtmlPart(19)
})
invokeTag('hasErrors','g',29,['bean':(codeInstance)],2)
printHtmlPart(12)
createTagBody(2, {->
printHtmlPart(20)
invokeTag('hiddenField','g',31,['name':("version"),'value':(codeInstance?.version)],-1)
printHtmlPart(21)
...
invokeTag('form','g',38,['url':([resource:codeInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(24)
})
